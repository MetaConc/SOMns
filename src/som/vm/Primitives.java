...
import som.primitives.AssertionPrimsFactory.AssertMessagePrimFactory;
...
import som.primitives.AssertionPrimsFactory.AssertPromiseMsgPrimFactory;
import som.primitives.AssertionPrimsFactory.AssertPromiseResolvedPrimFactory;
import som.primitives.AssertionPrimsFactory.AssertReleasePrimFactory;
import som.primitives.AssertionPrimsFactory.AssertSenderPrimFactory;
...
public class Primitives {
  ...
  private static List<NodeFactory<? extends ExpressionNode>> getFactories() {
    ...
    allFactories.add(AssertMessagePrimFactory.getInstance());
    allFactories.add(AssertSenderPrimFactory.getInstance());
    allFactories.add(AssertPromiseMsgPrimFactory.getInstance());
    ...
    allFactories.add(AssertPromiseResolvedPrimFactory.getInstance());
