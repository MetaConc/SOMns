...
public abstract class EventualMessage {
  ...
  public static final class PromiseCallbackMessage extends PromiseMessage {
    ...
    /*
     * PromiseCallbackMessages are created by the owner of the promise. The form the callback that is called upon promise resolution.
     * When creating the message the resolver of the promise is not known.
     */
